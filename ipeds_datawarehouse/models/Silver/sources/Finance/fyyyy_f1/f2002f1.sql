 WITH f2002_f1 AS (
    SELECT * FROM {{ source('bronze', 'f2002_f1') }}
 )
 , f2002_f1_renamed AS (
    SELECT
        ...
        -- Endowment
        CAST(NULL AS NUMERIC) AS "F1H01",
        CAST(NULL AS NUMERIC) AS "F1H02",
        CAST(NULL AS NUMERIC) AS "F1H03"

    FROM f2002_f1
 )

 SELECT * FROM f2002_f1_renamed