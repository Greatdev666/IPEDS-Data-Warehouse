 WITH f2021_f1 AS (
    SELECT * FROM {{ source('bronze', 'f2021_f1') }}
 )
 , f2021_f1_renamed AS (
    SELECT
        ...
        -- Pension / OPEB
        CAST("F1M01" AS NUMERIC) AS "F1M01",
        CAST("F1M02" AS NUMERIC) AS "F1M02",
        CAST("F1M05" AS NUMERIC) AS "F1M05",
        CAST("F1M06" AS NUMERIC) AS "F1M06",
        ...
        CAST("F1H03" AS NUMERIC) AS "F1H03"

    FROM f2021_f1
 )

 SELECT * FROM f2021_f1_renamed